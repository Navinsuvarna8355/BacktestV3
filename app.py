...
def calculate_indicators(df, length, short_period, long_period):
    ...
    # Drop rows with NaN values in EMA_Length to ensure aligned shapes
    # This is the key fix for the ValueError
    df.dropna(subset=['EMA_Length'], inplace=True)
    
    # Ab shapes aligned hain, to calculation sahi se hoga
    ...
    # Drop any new NaNs from the later EMAs
